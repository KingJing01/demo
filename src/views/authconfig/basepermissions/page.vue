  ...
  data() {
    return {
      ...
      formRules: {
        ...
        Name: [{ required: true, trigger: 'change', message: '菜单编码为必填项' }, { max: 40, message: '输入内容最大长度为40', trigger: 'change' }],
        DisplayName: [{ required: true, trigger: 'change', message: '菜单名称为必填项' }, { max: 20, message: '输入内容最大长度为20', trigger: 'change' }]
      }
    }
  },
  created() {
